...
const development = {
  ...
  google_client_id:
    "886167792839-2i5in2lhbt46vb11niuuhpi8aft29mll.apps.googleusercontent.com",
...
module.exports =
  eval(process.env.THE_SOCIAL_NETWORK_ENVIRONMENT) == undefined
    ? development
    : eval(process.env.THE_SOCIAL_NETWORK_ENVIRONMENT);
